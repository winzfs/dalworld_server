...
async function createAuthSchema(db: D1Database): Promise<void> {
  await db.batch([
    ...
    db.prepare(`CREATE INDEX IF NOT EXISTS idx_auth_sessions_account_id ON auth_sessions(account_id)`),
