...
const EARLY_RECIPES: CraftingRecipeDefinition[] = [
  ...
  recipe('craft:floor_kit', '바닥 키트', 'early', 'building_floor', [{ itemId: 'plank', quantity: 2 }], [{ itemId: 'floor_kit', quantity: 1 }], 50, 'workbench'),
  recipe('craft:floor_kit_bundle', '바닥 키트 묶음', 'early', 'building_floor', [{ itemId: 'plank', quantity: 10 }, { itemId: 'rope', quantity: 1 }], [{ itemId: 'floor_kit', quantity: 6 }], 51, 'workbench'),
  recipe('craft:wall_kit', '벽 키트', 'early', 'building_wall', [{ itemId: 'plank', quantity: 2 }], [{ itemId: 'wall_kit', quantity: 1 }], 60, 'workbench'),
  recipe('craft:wall_kit_bundle', '벽 키트 묶음', 'early', 'building_wall', [{ itemId: 'plank', quantity: 10 }, { itemId: 'rope', quantity: 1 }], [{ itemId: 'wall_kit', quantity: 6 }], 61, 'workbench'),
  recipe('craft:roof_kit', '지붕 키트', 'early', 'building_roof', [{ itemId: 'plank', quantity: 2 }, { itemId: 'stone_block', quantity: 1 }], [{ itemId: 'roof_kit', quantity: 1 }], 70, 'workbench'),
  recipe('craft:roof_kit_bundle', '지붕 키트 묶음', 'early', 'building_roof', [{ itemId: 'plank', quantity: 10 }, { itemId: 'stone_block', quantity: 5 }, { itemId: 'rope', quantity: 1 }], [{ itemId: 'roof_kit', quantity: 6 }], 71, 'workbench'),
